...
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.CgDqWq-O.js"), true ? __vite__mapDeps([0,1]) : void 0));
...
const RawTheme = {
  ...
  Layout() {
    return h(theme.Layout, null, {
      "doc-before": () => h("div", { class: "reader-status" }, [
        h("span", "WORKING DRAFT"),
        h("a", { href: "", target: "_blank", rel: "noopener", onClick(event) {
